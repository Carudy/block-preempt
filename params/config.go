...
var (
	...
	Config = &ChainConfig{
		...
		MinRelayBlockSize:        1,
		Inject_speed:             500, // default 2000
		Relay_interval:           1000,
		Max_Commit:               100000,
		Max_Commit_Block:         50, //MMM 多少区块后迁移，改小一点 原来是50
		ClientSendTX:             true,
		Stop_When_Migrating:      false, // default: false
		Lock_Acc_When_Migrating:  false, // default: false
		Bu_Tong_Bi_Li:            false,
